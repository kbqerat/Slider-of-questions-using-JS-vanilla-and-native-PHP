...
<body>
    <div class="container">
        ...
        <div class="formDiv success" style="margin-top: 30px;">

            <div class="left-text">
                <h1 class="success-message">Vous vous êtes enregistré avec succès !</h1>
            </div>
    ...
    <script>
        let logoutButton = document.querySelector(".formDiv.success .log-out");
